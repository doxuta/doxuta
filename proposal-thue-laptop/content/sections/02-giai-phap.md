...
Đây là tín hiệu niềm tin mạnh nhất mà ExamLap có: trong các đơn vị tại Đà Nẵng mà nhóm khảo được qua website công khai, không đơn vị nào công bố thông tin tương đương *[Cần kiểm chứng, xem mục E8 Phụ lục E]*.
:::

Chín hạng mục này được lặp lại sau **mỗi** lượt thuê, không phải làm một lần lúc nhập máy. Vòng đời đầy đủ của một thiết bị, gồm cả các nhánh bảo trì và thanh lý, nằm ở Chương 10.
...
| Hoàn cọc tự động trong 5 phút | Trả máy nguyên vẹn thì tiền cọc quay lại tài khoản trong vòng 5 phút, không cần nhắn tin hỏi | **Đối soát tự động**: hệ thống so bộ 6 ảnh lúc giao với bộ 6 ảnh lúc trả cùng checklist phần cứng; khớp hết thì hệ thống dựng sẵn lệnh hoàn tiền và đẩy đi ngay khi quản trị viên bấm duyệt, mục tiêu dưới 5 phút. Ở bản chạy được đầu tiên khâu duyệt vẫn do người thực hiện, vì nhóm chưa xác minh được cổng thanh toán trong nước có cơ chế hoàn tiền tự động hay không *[Cần kiểm chứng, xem mục E11 Phụ lục E]* | Thời gian hoàn cọc trung bình; tỉ lệ đơn phải can thiệp thủ công |
{caption: Ba cam kết dịch vụ công khai của ExamLap và cơ chế vận hành đứng sau từng cam kết.}
{widths: 3,4,7,3}

Cam kết thứ nhất dựa hoàn toàn vào vị trí. Cam kết tốt nhất tại Đà Nẵng hiện nay là "giao hàng trong ngày" [[ref:https://truonggiang.vn/cho-thue-laptop.html]], còn kỷ lục nhanh nhất cả nước là hai giờ và chỉ áp dụng ở nội thành Thành phố Hồ Chí Minh [[ref:https://laptopsgn.com/tin-tuc/dich-vu-cho-thue-laptop-tphcm-gia-re-giao-2h/]]. Với ca thi bắt đầu lúc 07:30, "trong ngày" là vô nghĩa. ExamLap không nhanh hơn nhờ chạy xe nhanh hơn mà nhờ đứng sẵn ở đó: campus nằm tại khu đô thị FPT, phường Hoà Hải, quận Ngũ Hành Sơn [[ref:https://daihoc.fpt.edu.vn/da-nang/]], trong khi các đơn vị cho thuê laptop của thành phố nằm rải ở Sơn Trà, Thanh Khê, Liên Chiểu và Cẩm Lệ, cách khu Hoà Hải 8 đến 15 km [[ref:https://danang.plus/thue-laptop/]].
...
Chênh lệch giá cũng không phải phần lãi ròng. Nó trả cho những thứ đối thủ không làm: công chuẩn bị chín hạng mục sẵn sàng thi cho mỗi lượt giao, máy dự phòng nóng nằm chờ suốt khung giờ thi, nhân viên trực tại campus vào giờ mà cửa hàng ngoài phố chưa mở cửa, và quỹ rủi ro cho hư hỏng. Doanh thu bình quân mỗi lượt thuê sau khi trộn các gói là 144.100đ. Con số đó cao hơn mặt bằng thuê ngày tại Đà Nẵng, vốn ở mức 29.000đ đến 50.000đ [[ref:https://truonggiang.vn/cho-thue-laptop.html]], và phần chênh lệch đi vào chi phí phục vụ chứ không vào lãi ròng.
