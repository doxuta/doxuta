...
| Xác thực | Liên kết đăng nhập một lần tới email `@fpt.edu.vn`, phiên trong Redis, ba vai `student`, `staff`, `admin`; **eKYC tự dựng bằng mã nguồn mở** (VietOCR, DeepFace, Silent-Face-Anti-Spoofing) chạy trên chính máy chủ của nhóm, theo lựa chọn đã chốt ở Chương 6 | Mật khẩu; đăng nhập Google; thuê dịch vụ eKYC thương mại | Bắt buộc email trường là lớp sàng lọc đầu vào rẻ và mạnh nhất; nhóm chưa có pháp nhân nên không ký được hợp đồng với nhà cung cấp nào, và không đưa vào bảng tài chính một khoản chi chưa ai công bố giá. Kiến trúc dựng theo mô hình máy chủ trung gian để khi có pháp nhân chỉ cần thay khoá và điểm cuối [[ref:https://docs-vision.fpt.ai/ekyc/I-introduction/gioi-thieu/]] [[ref:https://ekyc.vnpt.vn/vi/idcheck]] | Phụ thuộc máy chủ thư của trường; giá eKYC theo lượt chưa xác minh được |
...
| Tên miền `.vn` quy về tháng (từ năm thứ hai) | Năm đầu 770.000đ gồm lệ phí đăng ký, phí duy trì, phí tài khoản quản trị, **đã nằm trong bảng vốn đầu tư T-CAPEX**; dòng này là phí duy trì các năm sau | 65.000đ | Bảng phí của nhà đăng ký [[ref:https://helpdesk.inet.vn/knowledgebase/bang-gia-ten-mien-va-cac-loai-phi]] [[ref:https://vinahost.vn/phi-duy-tri-ten-mien/]] |
...
| 3 | Đơn quá hạn | Đơn "Đang thuê" đã qua `exam_slots.return_due_at` quá **15 phút**, báo lại mỗi giờ; quá **48 giờ** không liên lạc được thì đơn chuyển sang "Mất tài sản" | Nhắn tin tự động ở mốc 15 phút, nhắc lần hai kèm cảnh báo khoá ở mốc 60 phút, nhân viên gọi ở mốc 2 giờ, văn bản yêu cầu trả tài sản ở mốc 24 giờ, kết xuất hồ sơ và trình báo ở mốc 48 giờ — đúng năm mốc ở Phụ lục B mục B.4 |
