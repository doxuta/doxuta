...
```bash
# Bên khiếu nại tải ảnh về rồi tự tính lại mã băm và so với con số in trên biên bản PDF.
sha256sum mat-a-giao.jpg
# 9f2c...a41b  mat-a-giao.jpg
```
