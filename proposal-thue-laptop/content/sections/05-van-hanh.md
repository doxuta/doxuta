...
Năm thao tác bắt buộc có hai người duyệt: khoá màn hình từ xa, gỡ một khách khỏi danh sách chặn, hoàn tiền ngoài phạm vi tiền cọc, khấu trừ vượt biểu phí công khai, xoá dữ liệu cá nhân theo yêu cầu.
...
![Vòng đời một thiết bị trong đội máy ExamLap, từ lúc nhập máy, qua các chu kỳ cho thuê và bảo trì, tới quyết định thanh lý.](assets/diagrams/03-vong-doi-thiet-bi.png){w=13}{src: Nguồn: nhóm tác giả.}
...
| 70% đến 79% | Chỉ cho thuê ca thi nếu đã vượt bài đo thời lượng thực | Đo lại mỗi tháng, lên kế hoạch thay pin |
