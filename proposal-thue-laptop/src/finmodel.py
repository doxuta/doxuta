...
def md_tables():
    ...
    o.append(f"| Trừ: chi phí biến đổi mỗi lượt (công, eKYC, giao nhận, vật tư) | −{vnd(hv['bien_luot'])} |")
    o.append(f"| Trừ: trích quỹ dự phòng rủi ro, {QUY_RUI_RO_PCT*100:.0f}% doanh thu | −{vnd(dtl*QUY_RUI_RO_PCT)} |")
